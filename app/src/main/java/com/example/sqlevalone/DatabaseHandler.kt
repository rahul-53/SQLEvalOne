...
class DatabaseHandler(private val context: Context): SQLiteOpenHelper(context, "event_database",null, 1) {
    ...
    fun insertEvent(eventName:String, eventDesc : String, eventDate:String, eventLocation:String, eventPrice:String){
    ...
    fun updateEvent(id:Int, newEventName:String, newEventDesc : String, newEventDate:String, newEventLocation:String, newEventPrice:String) {
        val db:SQLiteDatabase = writableDatabase
        val contentValues = ContentValues()
    ...
    fun getEvents():MutableList<EventModal>{
